...
**版本**: v2.4.0
**更新时间**: 2025-10-14
**基础URL**: `http://localhost:8080/api/v1`/`http://8.138.115.164:8080/api/v1`
**部署服务器ip**：8.138.115.164
---
...
5. [分享相关API](#分享相关api) **🆕 v2.3.0**
   - [创建帖子分享链接](#1-创建帖子分享链接)
   - [解析分享链接](#2-解析分享链接)

6. [图片管理API](#图片管理api) **⚠️ 部分已废弃**
...
- `真实姓名不能为空`: 参数验证失败
- `手机号格式不正确`: 手机号格式错误
- `邮箱已被其他用户使用`: 邮箱唯一性约束冲突
- `手机号已被其他用户使用`: 手机号唯一性约束冲突
- `性别值无效`: gender参数不在允许范围内
    ...
    "images": [
      {
        ...
        "post_id": 1,
        "display_order": 1,
        "file_url": "/uploads/images/IMG_2025Q4_XYZ001.jpg",
        "thumbnail_url": "/uploads/thumbnails/IMG_2025Q4_XYZ001_thumb.jpg",
        "file_size": 1024000,
        "width": 1920,
        "height": 1080,
      ...
      },
      {
        ...
        "post_id": 1,
        "display_order": 2,
        "file_url": "/uploads/images/IMG_2025Q4_XYZ002.jpg",
        "thumbnail_url": "/uploads/thumbnails/IMG_2025Q4_XYZ002_thumb.jpg",
        "file_size": 856000,
        "width": 1920,
        "height": 1080,
        "mime_type": "image/jpeg",
      ...
      },
      {
        ...
        "post_id": 1,
        "display_order": 3,
        "file_url": "/uploads/images/IMG_2025Q4_XYZ003.jpg",
        "thumbnail_url": "/uploads/thumbnails/IMG_2025Q4_XYZ003_thumb.jpg",
        "file_size": 920000,
        "width": 1920,
        "height": 1080,
        "mime_type": "image/jpeg",
...
| success | boolean | 是否成功 |
| message | string | 返回消息 |
| data.posts | array | 帖子列表（包含images数组） |
...
**请求路径**: `/posts/:post_id/like/status`
...
**请求路径**: `/posts/:post_id/favorite/status`
